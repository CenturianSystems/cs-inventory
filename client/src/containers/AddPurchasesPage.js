      ...
      <Container>
        ...
        >
          {formData && formData.productItems ? (
            formData.productItems.map((product, index) => {
              return (
                <div
                  style={{
                  ...
                  <Form.Row>
                    ...
                    <Button
                      ...
                      style={{
                        ...
                        marginBottom: 32,
                        display:
                          formData.productItems.length > 1 ? "block" : "none",
                      }}
          ...
          <Form.Row>
            <Form.Group as={Col} controlId="formGridCity">
              <Form.Label>Invoice Price</Form.Label>
              <Form.Control
                name="purchasesPrice"
                onChange={handleFormChange}
              ...
              <Form.Control
                ...
                value={
                  formData.dateOfPurchase
                    ? new Date(formData.dateOfPurchase).toDateString()
                    : today.toDateString()
                }
              />
              <DayPicker
                month={
                  isNaN(new Date(formData.dateOfPurchase))
                    ? new Date(2020, 11)
                    : new Date(
                        new Date(formData.dateOfPurchase).getUTCFullYear(),
                        new Date(formData.dateOfPurchase).getUTCMonth()
                      )
                }
                showOutsideDays
